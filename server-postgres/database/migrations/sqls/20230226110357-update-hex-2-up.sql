...
CREATE OR REPLACE PROCEDURE update_hex_add_trees(
...
-- Stored Procedure for updating hex tiles when a tree is deleted
CREATE OR REPLACE PROCEDURE update_hex_delete_trees(
    IN p_longitude DECIMAL,
    IN p_latitude DECIMAL
) 
LANGUAGE plpgsql 
